...
<body>
    <form action="<?php print(_APP_URL);?>/app/kontroler.php" method="post">
        ...
        <input type="text" id="kwota" name="kwota" value="<?php isset($kwota)?print($kwota):""; ?>">

        <br>

        <label for="oprocentowanie">Oprocentowanie (%)</label>
        <input type="text" id="oprocentowanie" name="oprocentowanie" value="<?php isset($oprocentowanie)?print($oprocentowanie):""; ?>">

        <br>

        <label for="okres">Okres (lata)</label>
        <input type="text" id="okres" name="okres" value="<?php isset($okres)?print($okres):""; ?>">
